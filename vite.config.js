...
export default defineConfig({
  ...
  resolve: {
    alias: {
      app: path.resolve(fileURLToPath(new URL('.', import.meta.url)), './src/app'),
      pages: path.resolve(fileURLToPath(new URL('.', import.meta.url)), './src/pages'),
      widgets: path.resolve(fileURLToPath(new URL('.', import.meta.url)), './src/widgets'),
      features: path.resolve(fileURLToPath(new URL('.', import.meta.url)), './src/features'),
      entities: path.resolve(fileURLToPath(new URL('.', import.meta.url)), './src/entities'),
