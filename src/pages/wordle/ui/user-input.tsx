...
export function UserInput() {
    ...
    const [userInput, setUserInput, submitInput] = useUnit([$userInput, userInputChanged, userInputSubmitted]);
    ...
    return (
        <div>
            <form className="flex flex-col items-center gap-2" action="#" onSubmit={submitInput} ref={formRef}>
                <label htmlFor="userInput">Your guess</label>
                <input name="userInput" className="invisible hidden" type="text" value={userInput} onChange={(e) => setUserInput(e.target.value.toUpperCase())} />
